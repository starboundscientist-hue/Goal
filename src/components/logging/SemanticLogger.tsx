          ...
          {state === 'input' && (
            <div className="space-y-3">
              <textarea
                ...
                className="w-full bg-surface-base border border-surface-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground resize-none min-h-[80px] outline-none focus:border-blue-500"
                rows={3}
              />
          ...
          {state === 'preview' && (
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-surface-base border border-surface-border rounded-md px-2 py-1.5 text-sm text-foreground outline-none"
                  >
                    {CLUSTERS.map(c => (
              ...
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="done" className="text-sm text-foreground">Completed / done</label>
              ...
              <div className="flex justify-end gap-2 pt-1">
                <button onClick={() => setState('manual')}
                  className="text-xs text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-md border border-surface-border">
                  Edit manually
                </button>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="done2" checked={editDone}
                  onChange={e => setEditDone(e.target.checked)} className="accent-blue-500" />
                <label htmlFor="done2" className="text-sm text-foreground">Completed</label>
              </div>
